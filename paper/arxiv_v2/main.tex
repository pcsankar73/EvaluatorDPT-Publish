...
\end{cases}
\]
The distinction is not that thresholds are avoided. The distinction is that thresholds operate over a distribution that already contains a learned deferral class. This paper does not claim empirical superiority over all abstention baselines; it reports the evaluated behavior of a learned-deferral formulation and identifies abstention baselines as a necessary next comparison for a conference version.
