...
- Stage: S3B (running) — pending. S3A-v2 ep3 is current production best.
...
| S3B     | exp_t90_S3B_HdsOnly_v6nli_F8215_ep3          | Final heads-only calibration   | PENDING      | v6-corrected| Running 2026-05-21        |
| S4      | —                                             | Threshold sweep                | PENDING      | v6-corrected| After S3B                 |
