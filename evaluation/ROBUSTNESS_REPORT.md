...
This report summarizes robustness evidence available for the evaluated release. Dedicated external domain-transfer robustness suites are future work.

## Available Evidence

| Evidence | Result | Interpretation |
|---|---:|---|
| Full validation split | n=44,404 | Evaluates the held-out validation distribution |
| Full test split | n=44,597 | Evaluates the held-out test distribution |
| TBD qualitative audit | 7,758 errors / 44,597 | Residual errors concentrate around over-commit and false-deferral boundaries |
| High-confidence error comparison | 0.0558 → 0.0485 | Boundary refinement reduces high-confidence errors under paired comparison |
...
- Domain-transfer behavior is not established by these results.
